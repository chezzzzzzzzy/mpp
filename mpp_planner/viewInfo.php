                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <?php if ($data['adminFileUpload'] == NULL) {
                                        ...
                                        echo "<img src='".$data['adminFileUpload']."' >";

                                    }?>
                                </div>

                                <div class="col-lg-1">
                                    <label for="startDate">Download Images</label>
                                    <?php if ($data['requestorFileUpload'] == NULL) {
                                        echo "<br><b>No entries found</b>";         
                                    } else {
                                        echo "<img class='uploadedImage' src=' ".$data['requestorFileUpload'] ."' >";
                                        // echo "<img src='https://via.placeholder.com/200x300.png' alt=''>";
                                    }?>
                                    <br>
                                    <br>
                                    <input class='btn selectorButton2' value='Download'>                                    <br>
                    ...
                    <div class="col-lg-4">
                        <div class="boundingBox3">
                            <div class="row">
                                ...
                                <div class="col-lg-12 mlSmall">
                                    <h6><b>Length</b></h6>
                                    <h5><b><?php echo $data['rackSizeLength1'];?></b></h5>
                                </div>
                                ...
                                <div class="col-lg-12 mlSmall">
                                    <h6><b>Breadth</b></h6>
                                    <h5><b><?php echo $data['rackSizeBreadth1'];?></b></h5>
                                </div>
                                ...
                                <div class="col-lg-12 mlSmall">
                                    <h6><b>Height</b></h6>
                                    <h5><b><?php echo $data['rackSizeHeight1'];?></b></h5>
                                </div>
                                ...
                                <div class="col-lg-12 mlSmall">
                                    <h6><b>Weight</b></h6>
                                    <h5><b><?php echo $data['rackSizeWeight1'];?></b></h5>
                                </div>
                            </div>
                        </div>
                    </div>

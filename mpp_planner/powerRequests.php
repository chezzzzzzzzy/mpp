                            ...
                            <tbody>
                                <?php
                                    ...
                                    foreach ($pdo->query($sql) as $row) {
                                        ...
                                        echo '<td width=350>';
                                        echo '<a class="btn updateInfoButton" href="updateInfoPower.php?id='.$row['id'].'">Update</a>';
                                        echo ' ';
                                        echo '<a class="btn readInfoButton" href="viewInfoPower.php?id='.$row['id'].'">View</a>';
                                        echo ' ';
                                        echo '<a class="btn deleteInfoButton" href="deleteInfoPower.php?id='.$row['id'].'">Decline</a>';

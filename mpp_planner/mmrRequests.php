            ...
            <div class="col-lg-4">
                <div class="boundingBox2">
                    ...
                    <h2 class="mlSmall">
                        <b>
                            <?php
                                $sqlGetTotalInProgress = "SELECT COUNT(requestId) as `count` FROM mmrRequests";
                        ...
                        <tbody>
                            <?php
                                    ...
                                    foreach ($pdo->query($sql) as $row) {
                                        ...
                                        echo '<td width=350>';
                                        echo '<a class="btn updateInfoButton" href="updateInfoMmr.php?requestId='.$row['requestId'].'">Update</a>';
                                        echo ' ';
                                        echo '<a class="btn readInfoButton" href="viewInfoMmr.php?requestId='.$row['requestId'].'">View</a>';
                                        echo ' ';
                                        echo '<a class="btn deleteInfoButton" href="deleteInfoMmr.php?requestId='.$row['requestId'].'">Decline</a>';

...
if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true) {
    ...
    // START: planner is logged in, redirect to admin page
    header('Location: admin.php');
    // END: planner is logged in, redirect to admin page

} else { ?>


<!-- START: planner is not logged in, show login page  -->
<div class="container">
    <div class="row">
...
<!-- END: planner is not logged in, show login page  -->
<?php } ?>

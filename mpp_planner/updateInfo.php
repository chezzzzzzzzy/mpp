...
if (!empty($_POST)) {
    ...
    if (isset($_POST['upload'])) {
        ...
        // Get image name
        $adminFileUpload = "../mpp_storage/" . $id . "/" . $_FILES['image']['name'];
        // echo $adminFileUpload;

        // image file directory

        $file_path = "../" . 'mpp_storage' . "/" . $id . "/" ;
        $rack1Init = "../" . 'mpp_storage' . "/" . $id . "/Rack 1" . "/" ;
        $rack2Init = "../" . 'mpp_storage' . "/" . $id . "/Rack 2" . "/" ;
        $rack3Init = "../" . 'mpp_storage' . "/" . $id . "/Rack 3" . "/" ;
        $rack4Init = "../" . 'mpp_storage' . "/" . $id . "/Rack 4" . "/" ;
        $rack5Init = "../" . 'mpp_storage' . "/" . $id . "/Rack 5" . "/" ;
        ...
        $target = "../mpp_storage/" . $id . "/" . basename($adminFileUpload);

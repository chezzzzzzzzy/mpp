                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" style="width: 1%">Rack Location</th>
                            <th scope="col" style="width: 1%">FDF Rack Location</th>
                        ...
                        <?php 
                            ...
                            $sql = "SELECT * FROM cableTrayRequests";
                            ...
                            if(mysqli_num_rows($result) > 0){
                                    ...
                                    echo "<tr>";
                                        ...
                                        echo "<td>" . $row['fdfRackLocation'] . "</td>";
                                        echo "<td>" . $row['endDate'] . "</td>";
                                        echo "<td>PCM " . $row['room'] . "</td>";

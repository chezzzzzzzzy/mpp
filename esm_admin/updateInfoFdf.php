<?php
    ...
    if ( !empty($_POST)) {
        ...
        $numberOfCableTies = strval($_POST['numberOfCableTies']);
        ...
        if ($valid) {
            ...
            $sql = "UPDATE fdfRequests set requestorName = ?, requestorDepartment = ?, requestorEmail = ?, requestStatus = ?, numberOfPorts = ?, numberOfCableTies = ?, completionDate = ?, room = ? , exchange = ? WHERE id = ?";
            $q = $pdo->prepare($sql);
            $q->execute(array($name, $dept, $email, $requestStatus, $numberOfPorts, $numberOfCableTies, $completionDate, $room, $exchange, $id));
        ...
        $numberOfCableTies = $data['numberOfCableTies'];
            ...
            <div class="col-lg-12 ">
                <div class="infoBoundingBox">
                    <form class="form-horizontal" enctype="multipart/form-data"
                        action="updateInfoFdf.php?id=<?php echo $id?>" method="post">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label class="control-label">Number of Cable Ties</label>
                                    <div class="controls">
                                        <input class="form-control" name="numberOfCableTies" type="text"
                                            placeholder="numberOfCableTies"
                                            value="<?php echo !empty($numberOfCableTies)?$numberOfCableTies:'';?>">
                                    </div>
                                </div>
                            </div>
                        </div>

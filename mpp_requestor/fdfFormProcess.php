...
if (mysqli_query($conn, $sql)) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        while($row = mysqli_fetch_assoc($result)) {
            $requestId = $row['id'];
            $numberOfPorts = $row['numberOfPorts'];
            $numberOfCableTies = $row['numberOfCableTies'];
            $startDate = $row['startDate'];
            $endDate = $row['endDate'];
            $room = $row['room'];
            $exchange = $row['exchange'];
            $subject =  $row["id"] . " — Request for FDF ";
        }
    }                
            ...
            <div class='col-lg-12'>
                ...
                <div class='row'>
                    <div class='col-lg-2'>
                        Number of Ports
                        <br>
                        <h4><b>" . $numberOfPorts . "</b></h4>
                    </div>
                    <div class='col-lg-2'>
                        Number of Cable Ties
                        <br>
                        <h4><b>" . $numberOfCableTies . "</b></h4>
                    </div>
                </div>

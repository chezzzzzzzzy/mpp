...
$sql = "INSERT INTO mmrRequests (requestorName, requestorEmail, requestorDepartment, requestorReason, request, requestStatus) 
        VALUES ('$requestorName','$requestorEmail', '$requestorDepartment', '$requestorReason', '$request', 'Submitted')";

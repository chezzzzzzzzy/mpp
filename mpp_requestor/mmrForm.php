    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <form action="mmrFormProcess.php" id="msform" method="post" class="needs-validation">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="form-group">
                                    <label for="rackSize">Request<span class="requiredField">*</span></label>
                                    <textarea name="request" id="request" cols="30" rows="10" name="request" required></textarea>

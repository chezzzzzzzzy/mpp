    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-12 col-sm-12">
            <div class="bgcolors boundingBox2">
                <div class="row">
                    <div class="col-lg-12">
                        <h4 class="mlSmall"><b>SSU Request</b></h4>
                    </div>
                    <br>
                    <br>
            ...
            <div class="bgcolors boundingBox3">
                <div class="row">
                    ...
                    <div class="col-lg-12 mlSmall">
                        ...
                        <h6><b>Number of Ports</b></h6>
                        <?php 
                        if ($row['numberOfPorts'] != NULL) {
                            echo "<h3 class='valueEmphasis'><b>" . $row['numberOfPorts'] . "</b></h3>";
                        } else {
                        ...
                        <h6><b>Transmission Type</b></h6>
                        <?php echo "<h3 class='valueEmphasis'><b>" . $row['transmissionType'] .  "</b></h3>"; ?>
                        <br>


                        <h6><b>Interfacing Type</b></h6>
                        <?php echo "<h3 class='valueEmphasis'><b>" . $row['interfacingType'] .  "</b></h3>"; ?>
                        <br>

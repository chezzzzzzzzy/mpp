...
<body>
    ...
    <div class="container-fluid">
        ...
        <!-- END: image guidelines modal -->


        <!-- START: query for data in respective tables -->
        <form id="form1">
            <div class="row">
                <?php

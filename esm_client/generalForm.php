...
<body>
    ...
    <div class="container">
        ...
        <p class="formDescription">The Others request form allows you to request for the installation of ... </p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="form-group">
                                    <label for="query">Query<span
                                            class="requiredField">*</span></label>
                                    <input type="text" id="query" placeholder="Others"
                                        name="query" required>
